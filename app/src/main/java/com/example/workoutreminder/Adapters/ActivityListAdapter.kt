...
class ActivityListAdapter(val context: Context, private val todaysActivities: MutableList<Activity>): RecyclerView.Adapter<ActivityListAdapter.ViewHolder>() {

    val layoutInflater = LayoutInflater.from(context)
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        val tvTitle = itemView.findViewById<TextView>(R.id.tvActivityListTitle)
    }
